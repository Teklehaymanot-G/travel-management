...
-- AddForeignKey
ALTER TABLE `Witness` ADD CONSTRAINT `Witness_authorId_fkey` FOREIGN KEY (`authorId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WitnessComment` ADD CONSTRAINT `WitnessComment_witnessId_fkey` FOREIGN KEY (`witnessId`) REFERENCES `Witness`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WitnessComment` ADD CONSTRAINT `WitnessComment_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
