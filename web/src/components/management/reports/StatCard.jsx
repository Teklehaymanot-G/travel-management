...
const StatCard = ({ title, value, subtitle, icon, color = "blue" }) => {
  ...
  return (
    <div
      className={`bg-white p-6 rounded-lg border-2 ${colorClasses[color]} transition-all hover:shadow-md`}
    >
      <div className="flex items-center justify-between">
        ...
        <div
          className={`p-3 rounded-full ${colorClasses[color]} bg-opacity-50`}
        >
          {icon}
        </div>
      </div>
