...
const resources = {
  en: {
    translation: {
      ...
      sign_in_with_pin: "Sign in using your PIN",
      send_verification_code: "Send Verification Code",
      sign_in_now: "Sign In",
      invalid_credentials: "Invalid credentials",
      invalid_pin: "Invalid PIN",
      please_enter_valid_pin: "Please enter a valid PIN (4-6 digits)",
      pin_code: "PIN Code",
      enter_pin: "Enter PIN",
      ...
      // Booking list & payment status enhancements
      rejected: "Rejected",
      retry_payment: "Retry Payment",
      tickets_generating: "Tickets generating. Pull to refresh.",
      qr_generation_pending: "QR generation pending",
      none: "None",
      refresh: "Refresh",
      booking_detail: "Booking Detail",
      // Payment rejection dialog new keys
      ...
      // Booking/payment common
      no_bookings_yet: "No bookings yet",
      booking_created: "Booking created",
      proceed_to_payment_instruction:
  ...
  am: {
    translation: {
      ...
      sign_in_with_pin: "በPIN ይግቡ",
      send_verification_code: "ማረጋገጫ ኮድ ይላኩ",
      sign_in_now: "ግባ",
      invalid_credentials: "የመግቢያ መረጃ ትክክል አይደለም",
      invalid_pin: "የPIN አይገባም",
      please_enter_valid_pin: "እባክዎ ትክክለኛ 4-6 አሃዝ PIN ያስገቡ",
      pin_code: "PIN ኮድ",
      enter_pin: "PIN ያስገቡ",
      confirm_pin: "PIN ያረጋግጡ",
      reenter_pin: "PIN እንደገና ያስገቡ",
      ...
      secure_signin: "ደህንነቱ የተጠበቀ መግቢያ",
      pin_protection: "PIN ጥበቃ",
      ...
      version: "ስሪት",
      about_description:
        "TravelEase ጉዞዎችን እንዲፈልጉ፣ ቀላል እንዲያቀዱ እና ትኬቶቻቸውን በአንድ ቦታ እንዲቆጥቡ ይረዳዎታል።",
      ...
      rejected: "ተቀምጧል",
      retry_payment: "ክፍያን ደግመህ ሞክር",
      tickets_generating: "ትኬቶች በመፍጠር ላይ ናቸው። ለማደስ ይቀንሱ",
      qr_generation_pending: "QR ፈጠራ በመጠባበቅ ላይ",
      none: "የለም",
      refresh: "አድስ",
      booking_detail: "የቦኪንጅ ዝርዝር",
      // የክፍያ መቀበል መስርያ መረጃ አዲስ ቁልፎች
      ...
      // የቦኪንጅ/ክፍያ የተለመዱ ቁልፎች
      no_bookings_yet: "እስካሁን ቦኪንግ የለም",
      booking_created: "ቦኪንግ ተፈጥሯል",
      proceed_to_payment_instruction: "ቦኪንግዎን ለማረጋገጥ ወደ ክፍያ ቀጥሉ",
      status: "ሁኔታ",
      PENDING: "በመጠባበቅ ላይ",
      participants: "ተሳታፊዎች",
      add_payment: "ክፍያ ጨምር",
      ...
      enter_transaction_number: "የግብይት ቁጥር ያስገቡ",
      payment_date: "የክፍያ ቀን",
      receipt: "ደረሰኝ",
      payment_submitted: "ክፍያ ተገብቷል",
      awaiting_approval: "እየተጠባበቀ ነው",
      approved: "ተረጋግጧል",
      payment: "ክፍያ",
      ticket: "ትኬት",
